...
User uploads a PDF resume from the frontend
...
The AI returns structured JSON feedback

The frontend renders scores, insights, and recommendations
...
All AI inference is local for cost, privacy, and transparency
